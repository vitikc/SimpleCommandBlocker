...
public class Main extends JavaPlugin{
	...
	public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
		if(sender instanceof Player){
					...
					if(args.length!=0){
						switch(args[0]){
							case "add":
								...
								} else if (args.length<2){player.sendMessage(ChatColor.translateAlternateColorCodes('&', messageData.get("usage")) +": "+ ChatColor.translateAlternateColorCodes('&', messageData.get("usage_add")));
							...
							case "remove":
								...
								} else if (args.length<2){player.sendMessage(ChatColor.translateAlternateColorCodes('&', messageData.get("usage")) +": "+ ChatColor.translateAlternateColorCodes('&', messageData.get("usage_remove")));
			...
			} else {player.sendMessage(ChatColor.translateAlternateColorCodes('&', messageData.get("nopermission")));}
		} else {sender.getServer().getConsoleSender().sendMessage(SCBAnnouncer+ChatColor.translateAlternateColorCodes('&', messageData.get("can_senden_only_from")));}
		return true;
	}
}